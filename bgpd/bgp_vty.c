...
/* supports <unicast|multicast|vpn|labeled-unicast|flowspec|rtfilter> */
safi_t bgp_vty_safi_from_str(const char *safi_str)
{
	...
	if (strmatch(safi_str, "multicast"))
		...
		safi = SAFI_FLOWSPEC;
	else if (strmatch(safi_str, "rtfilter"))
		safi = SAFI_RTC;
	return safi;
}
