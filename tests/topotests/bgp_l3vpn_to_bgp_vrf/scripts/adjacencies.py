...
luCommand('ce4','vtysh -c "show bgp vrf all summary"',' 00:0','wait','Adjacencies up',shortWait)
...
# ARGH -- after waiting a while, this loops because it's '00:nn:nn'...
luCommand('r3','vtysh -c "show bgp summary"',' 00:.*','wait','Core adjacencies up', 180)
luCommand('r4','vtysh -c "show bgp summary"',' 00:.*','wait','Core adjacencies up', 180)
